...
{
    public partial class ItemCollectionView : DevExpress.XtraEditors.XtraUserControl, ISupportCollectionActions
    {
        ...
        public void New()
        {
            SharedView.ShowUserControlForm(new ItemView(bindingSource, Ebda3Soft.Core.Enums.TransactionType.Adding));
        }
        ...
        {
            if (IsReadyToEdit())
                SharedView.ShowUserControlForm(new ItemView(bindingSource, Ebda3Soft.Core.Enums.TransactionType.Modifying));
        }
        ...
        public void RefreshData()
        {
            ...
            dbContext.Items.LoadAsync().ContinueWith(loadTask =>
            {
                ...
                bindingSource.DataSource = dbContext.Items.Local.ToBindingList();
