...
{
    public partial class JournalTypeCollectionView : DevExpress.XtraEditors.XtraUserControl, ISupportCollectionActions
    {
        SQLServerDbContext dbContext;

        public JournalTypeCollectionView()
        {
            InitializeComponent();
        ...
        public void New()
        {
            ...
            SharedView.ShowUserControlForm(new JournalTypeView(bindingSource, Ebda3Soft.Core.Enums.TransactionType.Adding));
        }
        ...
        {
            if (IsReadyToEdit())
                SharedView.ShowUserControlForm(new JournalTypeView(bindingSource, Ebda3Soft.Core.Enums.TransactionType.Modifying));
        }
        ...
        public void RefreshData()
        {
           // Call the LoadAsync method to asynchronously get the data for the given DbSet from the database.
            dbContext.JournalTypes.LoadAsync().ContinueWith(loadTask =>
            {
                // Bind data to control when loading complete
                bindingSource.DataSource = dbContext.JournalTypes.Local.ToBindingList();
