...
{
    public partial class CurrencyView : XtraUserControl, IEntityControl
    {
        private SQLServerDbContext dbContext;
        private TransactionType transactionType;
        public BaseEntity BaseEntity { get; set; }

        public CurrencyView(BindingSource bindingSource, TransactionType transactionType)
        {
            InitializeComponent();
            SharedView.SetTranslate(dataLayoutControl1);
            SharedView.SetTranslate(IsLocalCheckEdit);
