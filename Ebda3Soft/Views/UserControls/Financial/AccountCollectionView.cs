...
{
    public partial class AccountCollectionView : DevExpress.XtraEditors.XtraUserControl, ISupportCollectionActions
    {
        ...
        public void RefreshData()
        {
            ...
            dbContext.Accounts.LoadAsync().ContinueWith(loadTask =>
            {
                ...
                bindingSource.DataSource = dbContext.Accounts.Local.ToBindingList();
        ...
        public void New()
        {
            SharedView.ShowUserControlForm(new AccountView(bindingSource, Ebda3Soft.Core.Enums.TransactionType.Adding));
        }
        ...
        {
            if (IsReadyToEdit())
                SharedView.ShowUserControlForm(new AccountView(bindingSource, Ebda3Soft.Core.Enums.TransactionType.Modifying));
        }

        private void AccountCollectionView_Load(object sender, EventArgs e)
        {
